...
> “Why is the model recommending items we can’t sell? It’s extremely frustrating for a user to receive a product recommendation, click on it, and then discover that the item is out of stock, discontinued, or only seasonally available.”

Not all recommendation logic belongs in the model. We need to add a business logic layer to our recommendation system.
...
Use the [cart_export_19_05.csv](../course/data/cart/cart_export_19_05.csv) data for the remainder of the questions.
