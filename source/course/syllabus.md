...
## CSE 455 Course Overview

Welcome to CSE 455 - Developing AI Systems

## Course Objectives

* Design and implement end-to-end AI systems. 
* Deploy AI systems into working environments. 
* Improve performance of a live AI system based on evaluation and monitoring. 
* Articulate the challenges of real-time, streaming data. 
* Identify ethical impacts of AI systems. 
...
This course is divided into two introductory projects and then a team project. The team project will be completed over four *sprints*. Each sprint will last approximately two weeks. Each of these sprints will be completed as teams. You will be required to provide feedback to your teammates at the end of each sprint as well as reflect on your learning.
...
!!!note "Time Expectations" 
	...
	While there will be some time provided in class for team assignments for campus students, as this is a three credit course, the expectation is that students will spend an average of six hours per week on assignments outside of class.
...
You'll work in teams of 3 to build an AI system of your choice. Your project must be approved by your instructor.

### Mini Lessons

During the team project portion of the course, you'll be given small lessons on how to use LLMs more efficiently and effectively in an AI system.
 ...
 * Module 01 - Example Case Study 1: 5%
 * Module 01 - Example Case Study 1 Executive Summary: 5%
 * Module 02 - Example Case Study 2: 5%
 * Module 02 - Example Case Study 2 Executive Summary: 5%
 * Module 03 - Team Project: 30%
 * Module 03 - Team Project Personal Contribution and Attendance: 20%
 * Module 03 - Team Project Executive Summary: 10%
 * Module 03 - Team Project Presentation: 10%
 * Module 03 - Mini Exercises: 10%
